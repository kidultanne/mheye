...
{
	global $themename;
	add_submenu_page("themes.php", ucfirst('medicenter'), "主题选项", "edit_theme_options", "ThemeOptions", $themename . "_options");
}
	...
	<form class="theme_options" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" id="theme-options-panel">
		<div class="header">
			<div class="header_left">
				<h3>
					<a href="http://www.4mudi.com" title="四亩地">
						四亩地
					</a>
				</h3>
				<h5>主题选项</h5>
			...
			<div class="header_right">
				<div class="description">
					<h3>
						<a href="http://www.4mudi.com/themes/medicenter" title="四亩地出品，必属精品">
							医疗中心
						</a>
					</h3>
					<h5>自适应医疗保健WordPress主题</h5>
				</div>
