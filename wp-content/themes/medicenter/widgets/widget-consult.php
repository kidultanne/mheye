...
class Example_Widget extends WP_Widget {
    ...
    function Example_Widget() {
        /* Widget settings. */
        $widget_ops = array( 'classname' => 'sec-page-content-right', 'description' => __('展示用户咨询平台', 'example') );
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance[' content_'] = $new_instance[' content_'];
    ...
    function form( $instance ) {
        ...
        $defaults = array( 'title' => __('Example', 'example'), 'content_type' => __('门诊时间', 'example'), 'sex' => 'male', 'show_sex' => true );
