...
class MatthiasWeb_AdvertHandler {
    ...
    public function register_fields() {
        ...
        add_settings_field(
        	...
        	'禁用MatthiasWeb信息插件列表，促进其他MatthiasWeb产品',
    ...
    public function setDefaultAdvertOf($of) {
        ...
        switch ($of) {
            ...
            case "rtg-regenerate":
                ...
                $advert->body = '<p>你已经调查了重新生成图像缩略图很久？
                   插件“Real Thumbnail Generator”将帮助您并给予您能力
                        <ul>
                            <li>... <strong>单独生成</strong>你的缩略图</li>
                            <li>... <strong>批量生成</strong>你的缩略图</li>
                            <li>... <strong>删除未使用的</strong>图片大小</li>
                            <li>... 为缩略图创建一个完全可定制的<strong>上传结构</strong>：<br /><strong>wp-content/uploads/thumbnails/mediuma/image.jpg</strong></li>
                        </ul>
                    </p>';
            ...
            case "rcl-order":
                ...
                $advert->subTitle = '自定义分类顺序';
                $advert->body = '<p>所有分类都可以自定义顺序，只需轻松点击一下？
                    没有问题，插件"Real Categories Management"解决了这个问题
                        <ul>
                            <li>... 在文章旁边创建树</li>
                            <li>... 创建<strong>自定义分类顺序</strong></li>
                            <li>... <strong>拖动</strong>文章到分类</li>
                            <li>... 切换分类法/页面<strong>无需重新加载页面</strong></li>
                            <li>... 为“页面”创建分类</li>
                            <li>... 管理您的<strong>自定义文章类型</strong></li>
                        </ul>
                    </p>';
                $advert->buttons[] = array(
            ...
            case "rml-drag-and-drop":
                ...
                $advert->body = '<p>
                    您对所有的媒体库直接对文件夹进行管理？
                    <strong>现有和未来的图片</strong>?
                    没问题，插件“Real Media Library”解决了这个问题，并给了你这个能力
                    <ul>
    ...
    <div id="matthiasweb-advert">
        ...
        <div id="matthiasweb-advert-using">
            此信息正在显示，因为您正在使用以下MatthiasWeb插件：<strong><?php echo $this->installedPluginsString(); ?></strong>
        </div>
    </div>
        <?php
    }
